...
return (new CustomEvent(event_name,(function (){var obj31191 = ({"detail":data});
return obj31191;
})()));
} else {
...
var f = (function (){var pred__31198 = cljs.core._EQ_;
var expr__31199 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31198.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31199))){
return (function (p1__31192_SHARP_){
return console.warn(p1__31192_SHARP_);
});
} else {
if(cljs.core.truth_(pred__31198.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31199))){
return (function (p1__31193_SHARP_){
return console.debug(p1__31193_SHARP_);
});
} else {
if(cljs.core.truth_(pred__31198.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31199))){
return (function (p1__31194_SHARP_){
return console.error(p1__31194_SHARP_);
});
} else {
return (function (p1__31195_SHARP_){
return console.log(p1__31195_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31202){
var map__31203 = p__31202;
var map__31203__$1 = cljs.core.__destructure_map.call(null,map__31203);
var opts = map__31203__$1;
var eval_fn = cljs.core.get.call(null,map__31203__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__31204_SHARP_){
return new_def.callback(p1__31204_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__31205){
var vec__31206 = p__31205;
var ky = cljs.core.nth.call(null,vec__31206,(0),null);
var v = cljs.core.nth.call(null,vec__31206,(1),null);
...
}catch (e31211){if((e31211 instanceof Error)){
var e = e31211;
return not_found;
} else {
throw e31211;
...
//# sourceMappingURL=utils.js.map?rel=1655118088629
